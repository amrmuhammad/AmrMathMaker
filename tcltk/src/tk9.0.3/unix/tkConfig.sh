...
TK_LIB_FILE='libtcl9tk9.0.a'

# Additional libraries to use when linking Tk.
TK_LIBS='-lX11 -lXss -lXext -lXft -lfontconfig -lfreetype  -lfontconfig  -ldl -lz  -lpthread -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tk9.0.3/unix -ltcl9tk9.0'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib -ltcl9tk9.0'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/include'
...
# compiled.
TK_SRC_DIR='/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tk9.0.3'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tk9.0.3/unix -ltkstub'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib -ltkstub'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tk9.0.3/unix/libtkstub.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib/libtkstub.a'

# Top-level directory in which Tk's demo files are installed.
TK_DEMO_DIR='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib/tk9.0/demos'
