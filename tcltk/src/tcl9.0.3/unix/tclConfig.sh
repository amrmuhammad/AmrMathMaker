...
# installed.
TCL_PREFIX='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tcl9.0.3/unix -ltcl9.0'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib -ltcl9.0'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/include'
...
# compiled.
TCL_SRC_DIR='/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tcl9.0.3'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tcl9.0.3/unix -ltclstub'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib -ltclstub'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/amrmuhammad/dev/AmrMathMaker/tcltk/src/tcl9.0.3/unix/libtclstub.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/amrmuhammad/dev/AmrMathMaker/tcltk/build/lib/libtclstub.a'
